...
myform =  create_formula( fdata, 'z_digit_re', c('SEQN', 'RIDAGEMN','RIDRETH3', 'CFASTAT', 'CFDCRNC', 'CFDCIT', 'CFDCST', 'CFDAPP', 'CFDAST', 'CFALANG', 'BPAARM', 'CFDCCS', 'CFDCST', 'CFDCIT', 'CFDCSR', 'CFDCIR', 'CFDCST', 'CFDCIT', 'CFDARNC', 'CFDDS',
...
initu=initializeSimlr( nh_list, k=50, jointReduction=TRUE )
...
cognames = c("z_cerad_re", "z_animal_re",     "z_digit_re",      "z_delayed_re",    "z_global_re"  )
