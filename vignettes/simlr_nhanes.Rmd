...
'age_cat','ridreth1','ridreth3','edu_cat','cfastat','year','riagendr','cerad_sum',
# 'wtint2yr','wtmec2yr',
...
colcats[ colnames(fdata) %in%  c("ridageyr","female") ]='demog'
colcats[ colnames(fdata) %in%  c("dmdeduc2","INDFMPIR") ]='demog'
...
simdf2$cfdds=fdata$cfdds
simdf2$cfdast=fdata$cfdast
